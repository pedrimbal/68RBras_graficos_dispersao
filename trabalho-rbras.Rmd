...
author: "Maria Julia, Murilo e Pedro"
date: "2024-04-06"
output:
  html_document:
    df_print: paged
...
*Gráfico de dispersão para duas variáveis independêntes*
```{r}
...
*Gráfico de dispersão para duas variáveis independêntes após transformações*
```{r}
